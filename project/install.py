...
def install():
    ...
    group_names = []
    install_update_module('clv_file_system_pharm', update, group_names)

    group_names = []
    install_update_module('clv_global_tag_pharm', update, group_names)

    group_names = []
    install_update_module('clv_medicament_pharm', update, group_names)
